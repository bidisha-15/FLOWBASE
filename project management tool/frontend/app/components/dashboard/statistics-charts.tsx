  ...
  return (
    <div className="grid gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mb-8">
      <Card className="lg:col-span-2">
        ...
        <CardContent className="w-full overflow-x-auto md:overflow-x-hidden flex justify-center">
              ...
              <PieChart>
                <Pie
                  data={[
                    { 
                      name: "Completed", 
                      value: stats.totalTaskCompleted || 0, 
                      color: "#10b981" 
                    },
                    { 
                      name: "In Progress", 
                      value: stats.totalTaskInProgress || 0, 
                      color: "#3b82f6" 
                    },
                    { 
                      name: "To Do", 
                      value: stats.totalTaskToDo || 0, 
                      color: "#6b7280" 
                    },
                  ]}
                  cx="50%"
                  ...
                  label={({ name, percent, value }) =>
                    (value || 0) > 0 ? `${name} ${((percent || 0) * 100).toFixed(0)}%` : ""
                  }
                  labelLine={false}
                >
                  {[
                    { name: "Completed", value: stats.totalTaskCompleted || 0, color: "#10b981" },
                    { name: "In Progress", value: stats.totalTaskInProgress || 0, color: "#3b82f6" },
                    { name: "To Do", value: stats.totalTaskToDo || 0, color: "#6b7280" },
                  ].map((entry, index) => (
                    <Cell key={`cell-${index}`} fill={entry.color} />
                  ))}
                </Pie>
