...
const ProjectDetails = () => {
  ...
  const { mutate: updateTaskStatus, isPending: isUpdatingStatus } = useUpdateTaskStatusMutation();
  ...
  const handleStatusUpdate = (taskId: string, newStatus: TaskStatus, event: React.MouseEvent) => {
...
interface TaskColumnProps {
  ...
  isFullWidth?: boolean;
  onStatusUpdate: (taskId: string, newStatus: TaskStatus, event: React.MouseEvent) => void;
          ...
          <div className="flex gap-1">
            {task.status !== "To Do" && (
              <Button
                ...
                size={"icon"}
                className="size-6"
                onClick={(e) => onStatusUpdate(task._id, "To Do", e)}
                title="Mark as To Do"
            ...
            {task.status !== "Done" && (
              <Button
                ...
                size={"icon"}
                className="size-6"
                onClick={(e) => onStatusUpdate(task._id, "Done", e)}
                title="Mark as Done"
                disabled={isUpdatingStatus}
              >
